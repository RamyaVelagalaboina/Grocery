...
import com.cg.groceryApp.service.ProductService;
...
//	Update
	...
	public ResponseEntity<Product> updateProduct(@Validated @PathVariable("productId") long productId, @RequestBody Product product) 
	{
